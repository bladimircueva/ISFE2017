 ...
 * @author Blad
 */
public class srvUniMedida extends HttpServlet {
    ...
    private clsUniMedida varUniMedida = null;
    
    
    public srvUniMedida()
    {
        varUniMedida = new clsUniMedida();
    }
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       JSONObject varJObjectLista = varUniMedida.metGetLista(); //To change body of generated methods, choose Tools | Templates.
    ...
    private void metCrear() throws SQLException {
        ...
        String VarAbreviacion = varRequest.getParameter("abreviacion");
        String UsuCodigo = varSession.getAttribute("session_usu_nombreusuario").toString();
        JSONObject varJObjectNuevoRegistro = varUniMedida.metNuevo(VarCodigo,VarDescripcion,VarAbreviacion,UsuCodigo);
        varOut.print(varJObjectNuevoRegistro);
    }

    private void metEliminar() throws SQLException {
        String VarId = varRequest.getParameter("id");
        JSONObject varJObjectLista = varUniMedida.metQuitar(VarId);
        varOut.print(varJObjectLista);
    }
    ...
    private void metModificar() throws SQLException{
        ...
        JSONObject varJObjectNuevoRegistro = varUniMedida.metEditar(VarId,VarCodigo, VarDescripcion,VarAbreviacion,VarUsuarioModificacion);
        varOut.print(varJObjectNuevoRegistro);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(srvUniMedida.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
